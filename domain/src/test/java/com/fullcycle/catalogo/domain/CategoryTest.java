...
public class CategoryTest {
    ...
    void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        final var expectedName = "Lorem Ipsum é simplesmente uma simulação de texto da indústria tipográfica e de impressos, " +
    ...
    public void givenAValidActiveCategory_whenCallDeactivate_thenReturnCategoryInactivated() {
        ...
        final var updatedAt = aCategory.getUpdatedAt().minusMillis(1L);
